    ...
    >
      <View style={styles.meta}>
        ...
        <Text
          style={[
            styles.eyebrow,
            {
              color: isDarkTheme ? theme.textSecondary : themes.global.white_90,
            },
          ]}
        >
          Cüz {juz} • Sayfa {page}
      ...
      <View style={styles.titleRow}>
        <View>
          <Text
            style={[
              styles.title,
              {
                color: isDarkTheme ? theme.textPrimary : themes.global.white_90,
              },
            ]}
          >
            {surahName}
        ...
        <Text
          style={[
            styles.arabicName,
            { color: isDarkTheme ? theme.gold : themes.global.white_90 },
          ]}
        >
          {surahNameArabic}
        </Text>
        ...
        style={[
          styles.preview,
          {
            ...
            backgroundColor: isDarkTheme
              ? theme.secondary
              : themes.global.white_10,
            borderColor: isDarkTheme
              ? theme.cardBorder
              : themes.global.white_15,
          },
        ]}
      >
        {arabicPreview}
      ...
      <Pressable
        ...
        style={[
          styles.button,
          { backgroundColor: isDarkTheme ? theme.accent : theme.cardBg },
        ]}
      >
        <Icon
          name="book.closed"
